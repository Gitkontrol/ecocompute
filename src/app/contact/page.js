      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="space-y-6 text-left bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-400 font-bold dark:text-gray-200">support@ecocompute.tech</span>
          </div>
          <div className="flex items-center gap-3">
            <Phone className="text-blue-500" />
            <span className="text-gray-400 font-bold dark:text-gray-200">+1 (925) 727-3169</span>
          </div>
          <div className="flex items-center gap-3">
            <MapPin className="text-blue-500" />
            <span className="text-gray-400 font-bold dark:text-gray-200">4268 South Black Horse Pike, Williamstown, New Jersey 08094 </span>
          </div>
        </div>
      </div>
    </div>
